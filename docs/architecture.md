# nf-core/starlight — Pipeline architecture
...
See [output.md](output.md) for file-level detail.
...
| Document | Contents |
|----------|----------|
| [pipeline_overview.md](pipeline_overview.md) | Colleague-facing step-by-step summary (incl. workflow-glue) |
| [first_implementations.md](first_implementations.md) | Implementation status, bug-fix log, open questions |
| [isoquant_implementation_plan.md](isoquant_implementation_plan.md) | IsoQuant modes, performance, output handling |
| [oarfish_implementation_plan.md](oarfish_implementation_plan.md) | Oarfish requirements, containers, validation |
| [quik_implementations.md](quik_implementations.md) | QUIK / barcode correction details |
| [output.md](output.md) | Published output file reference |
| [usage.md](usage.md) | Running the pipeline |
| [comparison.md](comparison.md) | Post-run quant method comparison scripts |
